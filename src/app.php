    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center"><span style="font-size:2em;"><i class="fas fa-certificate"></i></span><br>CATALOG</h5>
            <form class="form-signin" action="src/layout/page_model.php">
